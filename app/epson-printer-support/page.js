// app/epson-printer-support/page.js
...
export const metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'en_US',
    url: 'https://www.zamzamprint.com/epson-printer-support',
  ...
  alternates: {
    canonical: 'https://www.zamzamprint.com/epson-printer-support',
  },
  robots: {
    index: true,
    follow: true,
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12 font-sans text-gray-800">
      ...
      <div className="mt-10 text-gray-700 max-w-3xl">
        <p>
          📞 Call <strong>+1-888-769-4448</strong> for Epson help.
        </p>
      </div>
