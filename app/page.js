      ...
      {problems.map((problem, idx) => (
        ...
        >
          ...
          <div className="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity duration-500">
            <div className="bg-gradient-to-br from-blue-100 to-indigo-200 absolute inset-0" />
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricing.map((plan, idx) => (
              <div key={idx} className="bg-white p-8 rounded-2xl shadow-xl border-2 border-gray-200 hover:border-blue-500 transition-all duration-300 hover:scale-105">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {whyChoose.map((reason, idx) => (
              <div key={idx} className="flex items-start gap-3 bg-white p-6 rounded-xl shadow-md">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <figure className="rounded-lg overflow-hidden shadow-sm">
              <img src="/10140.jpg" alt="printer being set up" className="w-full h-40 object-cover" />
              <figcaption className="text-sm text-gray-600 p-2 text-center">Driver installation & setup</figcaption>
            </figure>
            <figure className="rounded-lg overflow-hidden shadow-sm">
              <img src="/8771958.jpg" alt="driver install" className="w-full h-40 object-cover" />
              <figcaption className="text-sm text-gray-600 p-2 text-center">Driver downloads & updates</figcaption>
            </figure>
            <figure className="rounded-lg overflow-hidden shadow-sm">
              <img src="/5144313.jpg" alt="wireless printer fix" className="w-full h-40 object-cover" />
              <figcaption className="text-sm text-gray-600 p-2 text-center">Wireless & Wi‑Fi fixes</figcaption>
            </figure>
            <figure className="rounded-lg overflow-hidden shadow-sm">
              <img src="/5150026.jpg" alt="remote fix" className="w-full h-40 object-cover" />
              <figcaption className="text-sm text-gray-600 p-2 text-center">Remote diagnostics & repairs</figcaption>
            </figure>
          </div>
        </div>
      </section>
