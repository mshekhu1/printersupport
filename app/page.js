...
export const metadata = {
  title: {
    absolute: 'Remote Printer Support for Home & Business | Fast US Service',
  },
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ───────── HERO ───────── */}
      <section className="relative pt-3 sm:pt-5 lg:pt-6 pb-8 sm:pb-12 lg:pb-16 overflow-hidden bg-white">
