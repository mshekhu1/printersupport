...
export const metadata = {
  ...
  keywords: ['printer offline', 'printer showing offline', 'fix printer offline', 'printer offline windows', 'wireless printer offline', 'printer offline fix', 'US printer support'],
...
export default function PrinterOfflineFixPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      {/* Hero Section */}
      <header className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-20 px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-10">
            {services.map((service, idx) => (
              <div key={idx} className="flex flex-col items-center p-6 bg-white bg-opacity-20 rounded-xl backdrop-blur-sm border border-white border-opacity-30 hover:bg-opacity-30 transition-all">
                <svg className="w-12 h-12 text-emerald-100 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
