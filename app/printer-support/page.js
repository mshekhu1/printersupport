          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              {printerTypes.map((type, idx) => (
                <div key={idx} className="bg-white p-6 rounded-xl shadow-md text-center border-2 border-gray-200 hover:border-blue-400 transition-all">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {faqs.map((faq, idx) => (
              <div key={idx} className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:border-blue-300 transition-all">
