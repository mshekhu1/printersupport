...
export const metadata = {
  title: 'Independent Remote Help for Brother Printers | ZamZam Print Support',
  ...
  openGraph: {
    title: 'Independent Remote Help for Brother Printers',
    ...
    <>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 font-sans text-gray-800">
        ...
        <p className="text-sm font-semibold text-slate-500 uppercase tracking-wide mb-3">
          Independent service · Not affiliated with Brother
        </p>
          <h1 className="text-4xl font-extrabold text-slate-900 mb-4 tracking-tight">
          Independent Remote Help for Brother Printers
        </h1>
