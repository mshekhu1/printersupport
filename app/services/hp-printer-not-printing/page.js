    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'HP printer not printing troubleshooting support',
      },
    ],
  },
  twitter: {
...
export default function HPPrinterNotPrinting() {
  ...
  return (
    <ServicePageShell
      ...
      title="HP Printer Not Printing? Here's How to Fix HP Printer Issues"
        intro={
          <>
            Your HP printer accepts print jobs but nothing prints. HP Smart shows everything's fine, but no output. Here's why—and exactly how to fix it. For expert help, visit our <Link href="/services/hp-printer-support" className="text-blue-700 font-bold hover:underline">HP Printer Support</Link> page.
          </>
        }
      faqs={faqs}
      relatedLinks={[
      ...
      footerSubcopy="If your HP printer continues to not print, professional diagnosis may be needed. Our support team specializes in HP printer issues and can help resolve printing problems."
    >
