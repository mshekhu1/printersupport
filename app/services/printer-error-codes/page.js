...
export const metadata = {
  title: 'Printer Error Codes — HP, Canon, Epson & Brother Fixes',
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Printer error code troubleshooting support',
      },
    ],
  },
  twitter: {
...
export default function PrinterErrorCodes() {
  ...
  const breadcrumbItems = [
    ...
    { name: 'Printer Error Codes', url: 'https://www.zamzamprint.com/services/printer-error-codes' }
  ];

  return (
    <ServicePageShell
      breadcrumbItems={breadcrumbItems}
      title="Printer Error Code? Here's How to Decode and Fix Printer Error Messages"
        intro={"Your printer is flashing an error code. The display shows numbers and letters you don't understand. Here's what they mean—and exactly how to fix them."}
      faqs={faqs}
      relatedLinks={[
          {
