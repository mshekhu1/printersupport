...
export default function PrinterBlankPages() {
  ...
  const breadcrumbItems = [
    ...
    { name: 'Printer Printing Blank Pages', url: 'https://www.zamzamprint.com/services/printer-printing-blank-pages' }
  ];

  return (
    <ServicePageShell
      breadcrumbItems={breadcrumbItems}
      title="Printer Printing Blank Pages? Here is the Hidden Fix."
        intro={"You checked the ink. You restarted the computer. It still prints white. Here is why—and exactly how to fix it."}
      faqs={faqs}
      relatedLinks={[
          {
            href: '/services/hp-printer-not-printing',
            label: 'HP Not Printing'
          },
          {
            href: '/services/epson-printer-not-printing',
            label: 'Epson Not Printing'
          },
          {
