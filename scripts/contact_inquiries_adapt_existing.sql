-- Your table already exists with:
-- id, name, email, phone, service, message, created_at
-- This does NOT add extra columns. Only grants + RPC for the website form.
...
-- Test:
-- select public.submit_contact_inquiry('+18885550123', 'Printer Offline', 'Brand: HP | test');
